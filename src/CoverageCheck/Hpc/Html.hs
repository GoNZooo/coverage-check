...
-- | Generates coverage information, given a 'HpcInfo' generated by
-- 'CoverageCheck.ProjectUtilities.streamHpcInfo' or
-- 'CoverageCheck.ProjectUtilities.findHpcReportFiles'. Note that this is only for one test suite
-- and that a package can contain multiple test suites.
